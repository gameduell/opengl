...
public class DuellGLActivityExtension extends Extension {
	...
	private static WeakReference<DuellGLActivityExtension> extension = new WeakReference<DuellGLActivityExtension>(null);
	private static WeakReference<DuellGLView> view = new WeakReference<DuellGLView>(null);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		extension = new WeakReference<DuellGLActivityExtension>(this);
